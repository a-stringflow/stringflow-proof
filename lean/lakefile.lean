...
lean_lib StringFlow where
  roots := #[`AllOddCert, `AutomatonInterface, `Axioms, `BalanceRecurrence,
    `BalanceReduction, `BasinBounds, `BasinCert, `BinaryDigits, `Certificates,
    ...
    `SurvExAudit, `S6Audit, `S6AuditStage1, `FinalStatement, `CycleBridge, `DwdbDiv, `Td0CertBridge, `Td0Final, `Td0Phase2, `Td0Real, `Td1, `Td1Final,
    `Td1Interp, `Td1Interval, `Td1Phase2, `Td1S3, `Td1Window, `TwoPowPlusOne,
    `Valuation, `WordWindow, `C4C8Tail, `FinitePrefix, `UnifiedCoreBridge, `UnifiedCoreAudit]
